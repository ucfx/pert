	...
	return (
		<>
			<div className="flex place-content-center">
				<table className="h-20 border-2 border-white rounded-xl">
					<thead>
						<tr>
							<th>Task</th>
							<th>Duration</th>
					...
					<tbody>
						...
						<tr>
							...
							<td className="max-w-[600px]">
								{/* select from previous tasks */}
								<div className="flex flex-row flex-wrap">
									<div className="flex w-[100px] justify-center border-2 border-white group">
										<h1>A</h1>
										<button className="hidden group-hover:block ml-2 text-red-500">
											X
										</button>
									</div>
									<div className="flex justify-center  w-[100px] border-2 border-white">
										<h1>B</h1>
									</div>
									<div className="flex justify-center  w-[100px] border-2 border-white">
										<h1>C</h1>
